       ...
       // private static int compteur = 0;
        ...
        public virtual bool Depot(Operation operation)
        {
            if(operation.Montant >= 0)
            {
                ...
                //}
                solde += operation.Montant;
                return DataContext.Data.SaveChanges() > 0;
            }
            return false;
        }
        ...
        public bool Save()
        {
            ...
            //command.Dispose();
            //connection.Close();
            DataContext.Data.Comptes.Add(this);
            DataContext.Data.SaveChanges();
            return Id > 0;
        }
        ...
        public static Compte GetCompte(int id)
        {
            ...
            //}
            return DataContext.Data.Comptes.Include(c => c.Client).Include(c => c.Operations).FirstOrDefault(c => c.Id == id);
        }
    }
}
